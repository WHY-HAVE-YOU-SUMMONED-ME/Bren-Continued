...
public class EnchantmentReg {
    ...
    public static Enchantment AUTOFILL = register("autofill", new AutofillEnchantment(Enchantment.Rarity.UNCOMMON));
    public static Enchantment PENETRATING = register("penetrating", new PenetratingEnchantment(Enchantment.Rarity.COMMON));
    public static Enchantment SILENCED = register("silenced", new SilencedEnchantment(Enchantment.Rarity.UNCOMMON));
    public static Enchantment STEADY_HANDS = register("steady_hands", new SteadyHandsEnchantment(Enchantment.Rarity.COMMON));
